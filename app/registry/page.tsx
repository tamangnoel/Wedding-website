    ...
    <div className="container mx-auto py-16 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-center text-muted-foreground max-w-2xl mx-auto mb-12">
          ...
          you wish to honor us with a gift, we've created registries at the
          following stores.
        </p>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <RegistryCard
            ...
            image="/placeholder.svg?height=200&width=200&text=%E2%9D%A4%EF%B8%8F"
            description="Shop our Amazon wedding registry filled with gifts we love"
          ...
          <div className="space-y-4">
            <div>
              <h3 className="font-medium">
                When will we receive registry gifts?
              </h3>
              <p className="text-muted-foreground">
                Gifts purchased through our registries can either be sent
                directly to our home before the wedding or brought to the
                reception. Each registry has shipping options available during
                checkout.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Each store has different policies regarding international
                shipping. Please check with the specific retailer for
            ...
            <div>
              <h3 className="font-medium">
                Can I purchase a gift not on your registry?
              </h3>
              <p className="text-muted-foreground">
                While we've selected items we'd love for our new home, we
                appreciate any gift you choose to give. The most important gift
                is your presence at our wedding.
              </p>
            </div>
          </div>
        </div>
